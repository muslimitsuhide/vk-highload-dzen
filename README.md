...
|Сервис|Описание|Пиковый RPS|CPU|
|------|-------|-----------|---|
|Auth  |авторизация|    8    |0.08|
|Reg   |регистрация|    1    |0.01|
|Create|создание контента|    303  |3.03|
|Grade |оценка публикаций|  6148   |61.48|
|Comment|написание комментария|||
|Subscribe|подписка на пользователей|244|2.44|
|Search|поиск|370|3.7|
|Feed|просмотр ленты|22222|222.22|
|Post, Article, Video|открытие публикации из ленты|1851|18.51|
