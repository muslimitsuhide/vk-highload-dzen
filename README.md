...
|Create|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|Grade |own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|Comment|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|Subscribe|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|Search|own|8 core CPU; 1x8 GB RAM 2400 MHz DDR4 (CyberServe EPYC EP1-102)|3|€1 677.53|€40|
|Feed|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|9|€6 019.68|€60|
|Post, Article, Video|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|6|€6 019.68|€60|
|Channel|own|8 core CPU; 1x8 GB RAM 2400 MHz DDR4 (CyberServe EPYC EP1-102)|3|€1 710.45|€40|
|ElasticSearch|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|PostgreSQL|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|MongoDB|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|Redis|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|
|Nginx|own|16 core CPU; 4x8 GB RAM 2400 MHz DDR4 (CyberServe Xeon SP1-P04S G4)|3|€6 019.68|€60|

Рассчитаем амортизацию на ближайшие 5 лет (60 месяцев):

Если будем арендовать оборудование, то получим следующую сумму:

`3*30*60 + 3*30*60 + 3*60*60 + 3*60*60 + 3*60*60 + 3*60*60 + 3*40*60 + 9*60*60 + 6*60*60 + 3*40*60 + 3*60*60 + 3*60*60 + 3*60*60 + 3*60*60 + 3*60*60 = €176 400`

### Итоги

Рассчитаем цену всего оборудования, если покупать его:

`6 019.68 * 42 + 1 710.45 * 12 + 1 677.53 * 3 = €278 385`
...
Таким образом, получаем следующие цифры: если закупать оборудование на расчетом на 5 лет, то вместе с поддержкой оно обойдется нам в `€518 385`, а если арендовать то же самое оборудование, то выйдет `€176 400`. Получается, если рассматривать период использования - 5 лет, то выгоднее будет арендовать оборудование, нежели покупать собственное.

Если рассматривать более долгосрочную амортизацию, то ситуация будет примерно такой же. Учитывая, что оборудование, в среднем, нужно менять каждые 10 лет. Получается, что нам выгоднее будет арендовать оборудование.
