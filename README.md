...
В Дзене основной функционал - это авторизация, регистрация и просмотр ленты и открытие интересующей публикации, остальной функционал может быть отключен при каких-то значительных сбоях.
