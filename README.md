...
Главной особенностью Дзен является рекомендательная лента, которая подстраивается под каждого пользователя на основе собранных данных (просмотренные видео, прочитанные статьи/посты, лайки, комментарии и другие действия во время использования сервиса) и дает пользователю только тот контент, который потенциально должен быть ему интересен. При взаимодействии с предложенным контентом система получает обратную связь, что также позволяет улучшать рекомендации.

### Список используемых источников <a name="8"></a>:
